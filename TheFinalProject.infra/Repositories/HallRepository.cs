...
namespace TheFinalProject.infra.Repositories
{
    public class HallRepository:IHallRepository
    {
        ...
        public async Task CreateHall(Hall hall)
        {
            ...
            param.Add("hallName", hall.HallName, dbType: DbType.String, direction: ParameterDirection.Input);
            ...
            param.Add("HLatitude", hall.Latitude, DbType.String, ParameterDirection.Input);
            param.Add("is_Available", hall.Isavailable, DbType.Int32, ParameterDirection.Input);
            ...
            var result = await _dbContext.Connection.ExecuteAsync("Hall_package.CreateHall", param, commandType: CommandType.StoredProcedure);
        }
        ...
        {
            var result = await _dbContext.Connection.QueryAsync<Hall>("Hall_package.GetAllHalls", commandType: CommandType.StoredProcedure);
        ...
        public async Task UpdateHall(Hall hall)
        {
            ...
            var result =  await _dbContext.Connection.ExecuteAsync("Hall_package.UpdateHallInformation", param, commandType: CommandType.StoredProcedure);
